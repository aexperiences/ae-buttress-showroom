/* mca-rtc.js — Harborline Architects (AEHub) NATIVE video conferencing (own WebRTC, no third party)
   ------------------------------------------------------------------------
...
(function () {
  ...
  var API = (window.BUTTRESS_API||'https://ae-connect-api.vercel.app')+'/api/connect';
  ...
  window.ButtressMeet = ESPOAPI; window.MCAMeet = ESPOAPI; window.ESPOMeet = ESPOAPI; window.LCPMeet = ESPOAPI;
})();
